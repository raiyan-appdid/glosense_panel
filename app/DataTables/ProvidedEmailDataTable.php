...
class ProvidedEmailDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\ProvidedEmail $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ProvidedEmail $model)
    {
    ...
    {
        return $this->builder()
            ->setTableId('providedemail-table')
    ...
    {
        return 'ProvidedEmail._' . date('YmdHis');
    }
}
