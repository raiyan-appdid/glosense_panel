<?php
        ...
        */
        ...
        return datatables()
            ...
            ->addColumn('action', function ($value) {
                $edit_route = route('admin.deliverycharges.edit', $value->id);
                $edit_callback = 'setValue';
                $modal = '#edit-deliverycharge-modal';
                $delete_route = route('admin.deliverycharges.destroy', $value->id);
            ...
            ->editColumn('created_at', function ($data) {
                ...
                $route = route('admin.deliverycharges.status');
        ...
        */
        public function query(DeliveryCharge $model)
        {
        ...
        */
        ...
        {
        return $this->builder()
            ->setTableId('deliverycharge-table')
        ...
        */
        ...
        {
        return 'DeliveryCharge._' . date('YmdHis');
        }
        }