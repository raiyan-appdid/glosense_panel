    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($value) {
                $edit_route = route('admin.gallerys.edit', $value->id);
                $edit_callback = 'setValue';
                $modal = '#edit-gallery-modal';
                $delete_route = route('admin.gallerys.destroy', $value->id);
            ...
            ->editColumn('created_at', function ($data) {
                ...
                $route = route('admin.gallerys.status');
