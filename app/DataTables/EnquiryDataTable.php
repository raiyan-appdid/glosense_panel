...
class EnquiryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            //     $edit_route = route('admin.enquirys.edit', $value->id);
            //     $edit_callback = 'setValue';
            //     $modal = '#edit-enquiry-modal';
            //     $delete_route = route('admin.enquirys.destroy', $value->id);
            ...
            //     $route = route('admin.enquirys.status');
