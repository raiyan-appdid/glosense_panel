...
class CcAvenueOrderController extends Controller
{
    public function store(Request $request)
    {
        ...
        $order = $paymentService->createOrder(
            ...
            additional_data: ['billing_name' => $request->name, 'billing_tel' => $request->number, 'billing_email' => $request->email, 'address' => $request->addresss, 'billing_zip' => $request->pincode, 'billing_tel' => $request->number, 'billing_city' => $request->city, 'billing_state' => $request->state, 'billing_country' => $request->country],
