    ...
    if ($(".big-slider").length > 0) {
      ...
      $(".big-slider-item").each(function () {
        ...
        if (bsi.find("video").length > 0) {
          ...
          var gifUrl = gif.find("img").attr("src");
          console.log(gifUrl);
          $(".bs-splitted .swiper-wrapper").append(
            '<div class="swiper-slide"><div class="big-image"><img src="' +
              bigImgUrl +
              '"></div><div class="row justify-content-center"><div class="col-lg-12 col-12 text-center"><div class="gif"><img src="' +
              gifUrl +
              '" alt="Big Slider Project Image"></div></div></div></div>'
          );
        }   
      });
