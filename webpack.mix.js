...
/*
 ...
 |--------------------------------------------------------------------------
 */
mixAssetsDir("site/assets/js/**/*.js", (src, dest) => mix.scripts(src, dest));
mixAssetsDir("site/assets/css/**/*.css", (src, dest) => mix.copy(src, dest));
mixAssetsDir("site/assets/**/**/img", (src, dest) => mix.copy(src, dest));
mixAssetsDir("site/home/js/**/*.js", (src, dest) => mix.scripts(src, dest));
mixAssetsDir("site/home/css/**/*.css", (src, dest) => mix.copy(src, dest));
mixAssetsDir("site/home/**/**/images", (src, dest) => mix.copy(src, dest));
...
mix
  ...
  .sass("resources/sass/custom/baguetteBox.scss", "public/css/custom", {
    sassOptions,
  })
  .sass(
    "resources/site/assets/sass/custom.scss",
    "public/site/assets/css/custom",
    {
      sassOptions,
    }
  );
...
mix.copy(
  "./resources/js/custom/baguetteBox.js",
  "public/js/custom/baguetteBox.js"
);
