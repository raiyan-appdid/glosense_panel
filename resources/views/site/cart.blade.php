                                ...
                                <div class="col-lg-8">
                                    <div class="cart__table">
                                            ...
                                            <tbody class="cart__table--body">
                                                ...
                                                @forelse ($carts as $cart)
                                                    <tr class="cart__table--body__items">
                                                        <td class="cart__table--body__list">
                                                            <div class="cart__product d-flex align-items-center">
                                                                <button class="cart__remove--btn"
                                                                    onclick="deleteItem(this, {{ $cart->id }})"
                                                                ...
                                                                <div class="cart__content">
                                                                    <h3 class="cart__content--title h4"><a
                                                                            href="product-details.html">{{ $cart->product->title }}</a>
                                                                    </h3>
                                                                    <span class="cart__content--variant">Manufacturer:
                                                                        {{ $cart->product->manufacturer }}</span>
                                                                    <span class="cart__content--variant">Made In:
                                                                        {{ $cart->product->made_in }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="cart__table--body__list">
                                                            <span
                                                                class="cart__price">₹{{ $cart->product->discounted_price }}</span>
                                                        </td>
                                                        <td class="cart__table--body__list">
                                                            <div class="quantity__box">
                                                                ...
                                                                <label>
                                                                    <input type="number"
                                                                        ...
                                                                        data-id="{{ $cart->id }}" />
                                                                    {{-- onchange="updateCart(this,{{ $cart->id }})"  --}}
                                                                </label>
                                                                <button type="button"
                                                        ...
                                                        <td class="cart__table--body__list">
                                                            <span
                                                                class="cart__price end">₹{{ $cart->quantity * $cart->product->discounted_price }}</span>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="continue__shopping d-flex justify-content-between">
                                            <a class="continue__shopping--link" href="{{ route('product') }}">Continue
                                                shopping</a>
                                            <button class="continue__shopping--clear" type="submit" onclick="clearCart()">Clear
                                                Cart</button>
                                        </div>
                                    </div>
                                </div>
                ...
                @else
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center mt-5">
                            <p class="no-product">Opps! No product found login to see your Cart!.</p>
                        </div>
                    </div>
                @endauth
            </div>
    ...
    @section('page-script')
        <script>
            $(document).on('click', '.increase', function() {
                ...
                const element = $(this).closest('tr').find('[data-counter]').val();
                updateCart(element, id);
            });
            ...
            function deleteItem(element, id) {
                Notiflix.Loading.standard('Updating cart...');
                $.ajax({
            ...
            function clearCart() {
                if (confirm('Sure you want to clear you cart ?')) {
                    $.ajax({
                        type: "post",
