                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-40">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="{{ route('blog-detail') }}">
                                        <img class="blog__card--thumbnail__img"
                                            src="{{ asset('site/assets/img/blog/blog1.webp') }}" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="{{ route('blog-detail') }}">Justo Pellentesque
                                            Donec
                                            lobortis faucibus Vestibulum</a></h3>
                                    <a class="blog__card--link" href="{{ route('blog-detail') }}">Read More</a>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-40">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="{{ route('blog-detail') }}">
                                        <img class="blog__card--thumbnail__img"
                                            src="{{ asset('site/assets/img/blog/blog2.webp') }}" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    <div class="blog__meta d-flex">
                                    ...
                                    <h3 class="blog__card--title"><a href="{{ route('blog-detail') }}">Lorem ipsum dolor
                                            sit, amet
                                            adipisici elit. aliquam.</a></h3>
                                    <a class="blog__card--link" href="{{ route('blog-detail') }}">Read More</a>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-40">
                            <article class="blog__card">
                                <div class="blog__card--thumbnail">
                                    <a class="blog__card--thumbnail__link" href="{{ route('blog-detail') }}">
                                        <img class="blog__card--thumbnail__img"
                                            src="{{ asset('site/assets/img/blog/blog3.webp') }}" alt="blog-img">
                                    </a>
                                </div>
                                <div class="blog__card--content">
                                    <div class="blog__meta d-flex">
                                    ...
                                    <h3 class="blog__card--title"><a href="{{ route('blog-detail') }}">Numquam nulla
                                            ducimus neque,
                                            officiis perfere vol!</a></h3>
                                    <a class="blog__card--link" href="{{ route('blog-detail') }}">Read More</a>
                                </div>
                            </article>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 mb-40">
                            <article class="blog__card">
                                ...
                                <div class="blog__card--content">
                                    ...
                                    <h3 class="blog__card--title"><a href="{{ route('blog-detail') }}">Mollitia in veniam
                                            magnam
                                            ipsam possimus dolores?</a></h3>
                                    <a class="blog__card--link" href="{{ route('blog-detail') }}">Read More</a>
                                </div>
                            </article>
                        </div>
