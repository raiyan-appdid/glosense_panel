                    ...
                    <form action="#">
                        ...
                        <div class="cart__table">
                            <table class="cart__table--inner">
                                <thead class="cart__table--header">
                                    <tr class="cart__table--header__items">
                                        ...
                                        <th class="cart__table--header__list text-center">Stock</th>
                                    ...
                                    @forelse ($wishlists as $wishlist)
                                        <tr class="cart__table--body__items">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    <button class="cart__remove--btn"
                                                        onclick="removeItem(this,{{ $wishlist->id }})"
                                                    ...
                                                    <div class="cart__thumbnail">
                                                        <a href="{{ route('product-detail', $wishlist->product->slug) }}"><img
                                                                class="border-radius-5"
                                                                src="{{ asset($wishlist->product->images[0]->image) }}"
                                                                alt="cart-product"></a>
                                                    </div>
                                                    <div class="cart__content">
                                                        ...
                                                        <span class="cart__content--variant">Manufacturer:
                                                            {{ $wishlist->product->manufacturer }}</span>
                                                        <span class="cart__content--variant">Made in:
                                                            {{ $wishlist->product->made_in }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="cart__table--body__list">
                                                <span class="cart__price">₹
                                                    {{ $wishlist->product->discounted_price }}</span>
                                            </td>
                                            <td class="cart__table--body__list text-center">
                                                <span class="in__stock text__secondary">
                                                    @if ($wishlist->product->in_stock == 'yes')
                                                        In Stock
                                                    @else
                                                        Out of stock
                                                    @endif
                                            ...
                                            <td class="cart__table--body__list text-right">
                                                <button type="button" class="wishlist__cart--btn primary__btn"
                                                    @if ($wishlist->product->in_stock == 'yes') onclick="addToCard(this,{{ $wishlist->product->id }})" @endif>
                                                    @if ($wishlist->product->in_stock == 'yes')
                                                        Add
                                                        To
                                                        Cart
                            ...
                            <div class="continue__shopping d-flex justify-content-between">
                                <a class="continue__shopping--link" href="{{ route('product') }}">Continue shopping</a>
                                <a class="continue__shopping--clear" href="{{ route('product') }}">View All Products</a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <article class="product__card">
                                <div class="product__card--thumbnail">
                                    ...
                                    <div class="product__add--to__card">
                                        <a class="product__card--btn" title="Add To Card" href="{{ route('cart') }}">
                                            Add to Cart
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="{{ route('product-detail') }}">Z 7-8mm
                                            Freshwater
                                            Button is </a></h3>
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="{{ route('product-detail') }}">Lorem, ipsum
                                            dolor sit
                                            ame elit. </a></h3>
                                    <div class="product__card--price">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="{{ route('product-detail') }}">Cotur, cing
                                            elit.
                                            Doloque, beatae. </a></h3>
                                    <div class="product__card--price">
                        ...
                        <div class="swiper-slide">
                            <article class="product__card">
                                ...
                                <div class="product__card--content text-center">
                                    ...
                                    <h3 class="product__card--title"><a href="{{ route('product-detail') }}">Unde quaerat
                                            minus
                                            ipsa excei! </a></h3>
                                    <div class="product__card--price">
    ...
    @section('page-script')
        <script>
            ...
            function removeItem(element, id) {
                Notiflix.Loading.standard('Removing item...')
                $.ajax({
                    type: "post",
                    ...
                    success: function(response, status) {
                        ...
                        if (status == 'success') {
                            ...
                            Notiflix.Notify.failure('Opps! try after sometime');
