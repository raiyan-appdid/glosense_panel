                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="about__thumbnail padding__left position-relative">
                            <img src="{{ asset('site/assets/img/other/about.webp') }}" alt="img">
                            <div class="about__experience--text text-center">
                                <span class="about__experience--years"><span
                                        class="about__experience--years__inner">15</span>+</span>
                ...
                <div class="team__container">
                    <div class="row mb--n30">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img" src="{{ asset('site/assets/img/other/team1.webp') }}"
                                        alt="team img">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img" src="{{ asset('site/assets/img/other/team2.webp') }}"
                                        alt="team img">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img" src="{{ asset('site/assets/img/other/team3.webp') }}"
                                        alt="team img">
                                </div>
                                <div class="team__content">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('site/assets/img/other/testimonial1.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                ...
                                <div class="testimonial__content">
                                    ...
                                    <img class="testimonial__vector--icon"
                                        src="{{ asset('site/assets/img/icon/vector-icon.webp') }}" alt="icon">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('site/assets/img/other/testimonial2.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('site/assets/img/other/testimonial3.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                                        <h3 class="testimonial__author--title">Michael Linda</h3>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items">
                                <div class="testimonial__author d-flex align-items-center">
                                    <div class="testimonial__author__thumbnail">
                                        <img src="{{ asset('site/assets/img/other/testimonial4.webp') }}"
                                            alt="testimonial-img">
                                    </div>
                                    <div class="testimonial__author--text">
                                        <h3 class="testimonial__author--title">Lee Barners</h3>
